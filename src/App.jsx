...
const courseContent = [
    ...
    // BLOCK 1
    { week: 1, title: "The Mind as the Starting Block", icon: Dribbble, concept: "Every action is preceded by a thought. This week, we learn to become the calm observer of our thoughts.", weeklyIntro: "Welcome to Week 1. Before we can learn to direct our thoughts, we must first learn to simply observe them without judgment. This week's drills are designed to build the foundational skill of awareness.", dailyLessons: Array(7).fill({day: 1, title: "Daily Drill", instructions: "...", deeperDive: "..."}), journalPrompts: Array(7).fill("...") },
    { week: 2, title: "Control the Mental Locker Room", icon: BrainCircuit, concept: "Your brain forms habits through neural pathways. This week, we strategically re-wire your automatic mental responses.", weeklyIntro: "This week, you become the gatekeeper of your mind. You will learn to control the narrative in your head, which directly influences your confidence.", dailyLessons: Array(7).fill({day: 1, title: "Daily Drill", instructions: "...", deeperDive: "..."}), journalPrompts: Array(7).fill("...") },
