...
const courseContent = [
    ...
    { 
      ...
      icon: Dribbble,
      concept: "Every action is preceded by a thought. This week, we learn to become the calm observer of our thoughts.",
      weeklyIntro: "Welcome to Week 1. Before we can learn to direct our thoughts, we must first learn to simply observe them without judgment. This week's drills are designed to build the foundational skill of awareness.",
      dailyLessons: Array(7).fill({day: 1, title: "Daily Drill", instructions: "...", deeperDive: "..."}), journalPrompts: Array(7).fill("...") },
    { 
      week: 2, 
      title: "Control the Mental Locker Room", 
      icon: BrainCircuit, 
      concept: "Your brain forms habits. This week, we re-wire your automatic responses.",
      weeklyIntro: "This week, you become the gatekeeper of your mind. You will learn to control the narrative in your head.",
      dailyLessons: Array(7).fill({day: 1, title: "Daily Drill", instructions: "...", deeperDive: "..."}), journalPrompts: Array(7).fill("...") },
    // Weeks 3-24 are placeholders for brevity but would follow the same detailed structure
    { week: 3, title: "The Power of Unwavering Focus", icon: Target, concept: "Focus is a muscle.", weeklyIntro: "This week, you'll learn to direct your attention like a laser beam.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 4, title: "Building Your Mental Blueprint", icon: BrainCircuit, concept: "Your brain can't tell the difference between vivid imagination and reality.", weeklyIntro: "This week, you become the architect of your success.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 5, title: "HD Visualization: Making It Real", icon: Star, concept: "A blurry mental image has little power.", weeklyIntro: "This week, you become the star of your own mental movie.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 6, title: "Defining Your Victory", icon: Target, concept: "A clear goal gives your brain direction.", weeklyIntro: "This week, you will program your brain's internal 'GPS'.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 7, title: "Building Unshakable Belief", icon: Star, concept: "Belief is a feeling of certainty.", weeklyIntro: "This week, you will learn to harness the emotions of past victories.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 8, title: "Game Day Integration", icon: Dribbble, concept: "Create a strategic mental warm-up.", weeklyIntro: "This final foundational week is about creating your pre-performance routine.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 9, block: 2, title: "Performing Under Pressure", icon: Award, concept: "Pressure is a privilege.", weeklyIntro: "This week, you learn to dictate your mental state to the situation.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 10, block: 2, title: "The Resilient Athlete", icon: Award, concept: "Resilience isn't about never failing; it's about bouncing back faster.", weeklyIntro: "This week, we will train your 'bounce-back' ability.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 11, block: 2, title: "Advanced Visualization: Opponent Modeling", icon: Award, concept: "Mentally scout your opponents to create a strategic advantage.", weeklyIntro: "This week, you'll learn to feel one step ahead of the competition.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 12, block: 2, title: "The Leader's Mindset", icon: Award, concept: "Leadership is a skill, not just a title.", weeklyIntro: "This week, you will practice the mental drills that build a leadership presence.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 13, block: 2, title: "The Confidence Bank", icon: Award, concept: "Confidence comes from evidence.", weeklyIntro: "This week, you will become the accountant for your own 'Confidence Bank.'", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 14, block: 2, title: "Automating Your Skills", icon: Award, concept: "Make your mental skills as automatic as your physical ones.", weeklyIntro: "This week is about reducing the conscious effort required to use your mental tools.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 15, block: 2, title: "The Off-Season Mind", icon: Award, concept: "Mental training doesn't stop when the season ends.", weeklyIntro: "This week is about applying your mental skills to your off-season training.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 16, block: 2, title: "The 'Why' Revisited", icon: Award, concept: "Reconnect with your deepest motivation for playing your sport.", weeklyIntro: "Your 'Why' is the ultimate fuel source. This week, we will reconnect with that core passion.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 17, block: 3, title: "Advanced Anchoring", icon: Star, concept: "Create different anchors for different mental states.", weeklyIntro: "This week, you will learn to create and use multiple anchors, each linked to a specific, desired mental state.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 18, block: 3, title: "Team Visualization", icon: Star, concept: "Extend your mental game to your entire team.", weeklyIntro: "This week, you will practice visualizing not just your own success, but the success of your team.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 19, block: 3, title: "Handling External Pressure", icon: Star, concept: "Build a mental shield against pressure from parents, coaches, and scouts.", weeklyIntro: "This week, you will learn to differentiate between what you can control and what you can't.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 20, block: 3, title: "The 'Inner Coach' Dialogue", icon: Star, concept: "Turn your mind into your most trusted advisor.", weeklyIntro: "Instead of just replacing a single thought, you will learn to have a full, constructive internal dialogue with your 'Inner Coach.'", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 21, block: 3, title: "Long-Term Goal Setting", icon: Star, concept: "Apply your goal-setting skills to your long-term athletic and life ambitions.", weeklyIntro: "A compelling long-term vision provides a powerful context for your daily efforts.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 22, block: 3, title: "The Mind-Body Connection", icon: Star, concept: "Use your mind to build a stronger, more resilient body.", weeklyIntro: "Your mental state directly affects your physical recovery. This week, we focus on using your mental skills to enhance your physical well-being.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
    { week: 23, block: 3, title: "The Gratitude Edge", icon: Star, concept: "Use gratitude to reduce performance anxiety and increase enjoyment.", weeklyIntro: "Gratitude is the powerful antidote to the burnout that comes from constantly striving.", dailyLessons: Array(7).fill({}), journalPrompts: Array(7).fill("...") },
